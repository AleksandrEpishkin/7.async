...
class AlarmClock {
    ...
    addClock(time, callback, id) {
        if (typeof id === 'undefined') {
            ...
            return console.error('The call already exists.');
        }
...
PhoneClock.addClock('09:01', () => console.log ('Пора вставать!'), 1);
PhoneClock.addClock('09:05', () => console.log ('Давай вставай уже!!!'), 2);
PhoneClock.removeClock(2);
PhoneClock.addClock('09:30', () => console.log ('Иди умывайся'), 3);
PhoneClock.start();
PhoneClock.stop();
